...
- **Severity:** Critical. Named execs: Sally Minto (Digital Director), Gita Samani (Strategy Director), Revolution Beauty. Quantified: 75%+ one-time purchasers; 8x ROI on RevRewards; +234% repeat purchase rate; +378% lifetime revenue per member; +44% AOV; members shop ~4x/yr (£174 lifetime revenue). Quote: 'Being able to gain customer insight and understand customer data has been absolutely key to growth.'