...
async function main() {
  // Try some CircleCI customer case studies from the list
  console.log('=== CircleCI Case Studies From List ===');
  const circleciSlugs = ['axios', 'contentful', 'launchdarkly', 'outreach', 'procore', 'snyk', 'tessian', 'toss', 'voiceflow', 'honeycomb'];
